...
public class ClipPictureActivity extends ImageBaseActivity {
    ...
    public static final String USER_PHOTO_URI = "user_photo_uri"; // 选择头像的本地地址
    ...
    protected void onCreate(Bundle arg0) {
        ...
        photoUri = getIntent().getStringExtra(USER_PHOTO_URI);
        if (photoPath == null) {
            finish();
            return;
        }
        int start = photoPath.lastIndexOf("/");
        bitmap = ImageUtils.getBitmap(photoPath,photoUri, 480, 480);
...
//            photoName = photoPath.substring(start + 1, photoPath.length());
            ...
            Log.e("ClipPictureActivity","path = " + photoPath);
